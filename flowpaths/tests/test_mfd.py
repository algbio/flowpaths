...
class TestMinFlowDecomp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.params = list(itertools.product(weight_type, \
    ...
    def test_min_flow_decomp_solved(self):
        ...
        for graph in self.graphs:
            ...
            for settings in self.params:
                ...
                if settings[1] == False and settings[2] == False and settings[3] == True:
                    continue
                # if optimize_with_greedy, it makes no sense to try the safety optimizations
                if settings[4] == True and (settings[2] == True or settings[3] == True or settings[4] == True):
                    continue
                ...
                if first_solution_size == None:
                    ...
                    self.assertEqual(first_solution_size, len(mfd_model.solution[0]), "The size of the solution should be the same for all settings.")
