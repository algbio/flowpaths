...
def main():
    ...
    mpe_model = fp.kMinPathError(graph, flow_attr="flow", num_paths=3, weight_type=float)
    ...
    mpe_model_2 = fp.kMinPathError(graph, flow_attr="flow", num_paths=3, weight_type=float, edges_to_ignore=edges_to_ignore)
    mpe_model_2.solve()
